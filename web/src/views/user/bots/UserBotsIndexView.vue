                        ...
                        <div class="modal fade" id="add-bot-btn" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title fs-5" id="exampleModalLabel">创建Bot</h5>
                                ...
                                <div class="modal-footer">
                                    <div class="error-message">{{ botadd.errorMessage }}</div>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" :id="'update-bot-modal' + bot.id" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-footer">
                                                    <div class="error-message">{{ bot.errorMessage }}</div>
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">取消</button>
...
export default {
    ...
    setup() {
        ...
        let bots = ref([]);         //ref定义变量

        const botadd = reactive({   //reactive定义对象
            title: "",
            description: "",
            content: "",
            errorMessage: "", 
        ...
        const add_bot = () => {
            ...
            $.ajax({
                ...
                data: {
                    title: botadd.title,
                    descripiton: botadd.description,
                ...
                success(resp) {
                    if (resp.errorMessage === "success") {
                        ...
                        botadd.description = "";
                        botadd.content = "";
                        //$("#bot-add-btn").modal("hide");
                        Modal.getInstance("#add-bot-btn").hide();
                        refresh_bots();
                    } else {
                        botadd.errorMessage = resp.errorMessage;
                    }
                },
